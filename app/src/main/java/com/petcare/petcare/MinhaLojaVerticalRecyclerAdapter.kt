...
class MinhaLojaVertcialRecyclerAdapter(private var context: Context, private var arrayNome:MutableList<String>, private var arrayImg:MutableList<String>, private var arrayDesc:MutableList<String>, private var arrayPreco:MutableList<String>, private var arrayBD:MutableList<String>): RecyclerView.Adapter<MinhaLojaVertcialRecyclerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(context).load(arrayImg.get(position)).apply(RequestOptions.circleCropTransform()).into(holder.img)

...
class MinhaLojaVertcialRemediosRecyclerAdapter(private var context: Context, private var arrayNome:MutableList<String>): RecyclerView.Adapter<MinhaLojaVertcialRemediosRecyclerAdapter.ViewHolder>() {

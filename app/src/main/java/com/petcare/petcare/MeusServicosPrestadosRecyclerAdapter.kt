...
class MeusServicosPrestadosRecyclerAdapter(private var context: Context, private var arrayServicosPrestados:MutableList<String>): RecyclerView.Adapter<MeusServicosPrestadosRecyclerAdapter.ViewHolder>() {

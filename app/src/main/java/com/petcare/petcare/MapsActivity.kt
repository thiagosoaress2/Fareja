...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!permissaoSeguindoGoogle()){ //sem autorização pede novamente
            ...
            //permissoes de camera, mapa
            permissaoSeguindoGoogle()
...
//        setUpMap()
    ...
    fun CalculeSeEsteEoMaiorPreco(valorDoBd: String, valorDaNovaVenda: String) :String {
        ...
        val maior: BigDecimal
        //maior ou igual pra ja contemplar essa possibilidade e não precisar fazer alteração
        if (precoArmazenadoBigDec>=precoNovoBigDec){
            maior = precoArmazenadoBigDec
        } else {
            maior = precoNovoBigDec
        }

        //aqui vamos usar a variavel de preco armazenado apenas pra nao precisar criar outra. Mas na verdade ela está passando o valor de val maior
        precoArmazenado = maior.toString()
        precoArmazenado = precoArmazenado.replace(".", ",")
    ...
    //avisa que o gps está desligado e o força a ligar
